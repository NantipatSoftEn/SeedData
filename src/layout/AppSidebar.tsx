...
const navItems: NavItem[] = [
...

  {
    name: 'Forms',
    icon: <ListIcon />,
    subItems: [{ name: 'Form Elements', path: '/form-elements', pro: false },{ name: 'Form Lamb Tracking ', path: '/form-lamb-tracking', pro: false }],
  },
  {
    name: 'Tables',
    icon: <TableIcon />,
    subItems: [{ name: 'Basic Tables', path: '/basic-tables', pro: false },{ name: 'Group Care Tables', path: '/group-care-tables', pro: false }],
  },
