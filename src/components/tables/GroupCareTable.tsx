...
export default function GroupCareTable() {
  return (
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {tableData.map(order => (
                <TableRow key={order.id}>
                  ...
                  <TableCell className="text-theme-sm px-4 py-3 text-start text-gray-500 dark:text-gray-400">
                    <div className="flex -space-x-2">
                      {order.team.images.map((teamImage, index) => (
                        <div key={index} className="h-6 w-6 overflow-hidden rounded-full border-2 border-white dark:border-gray-900">
                  ...
                  <TableCell className="text-theme-sm px-4 py-3 text-gray-500 dark:text-gray-400">{order.budget}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
