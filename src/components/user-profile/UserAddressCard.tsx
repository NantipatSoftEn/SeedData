    ...
    <>
      <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h4 className="text-lg font-semibold text-gray-800 lg:mb-6 dark:text-white/90">Contact Information</h4>
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">(555) 123-4567</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Email</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">sarah.j@example.com</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Job</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">Marketing Manager</p>
              </div>
            </div>
          </div>
          ...
          <form className="flex flex-col">
            <div className="custom-scrollbar overflow-y-auto px-2">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div>
                  <Label>Job</Label>
                  <Input type="text" defaultValue="Marketing Manager" />
                </div>
              </div>
            </div>
