...
import type { GiftFromGod } from '@/types/GiftFromGod'
...
const BlessingStatData = [
  ...
  {
    thaiName: 'ถ้อยคำประกอบด้วยสติปัญญา',
    score: 0,
    englishName: 'WordContainerIntelligence',
  },
  {
    thaiName: 'ถ้อยคำประกอบด้วยความรู้',
    score: 0,
    englishName: 'WordContainKnowledge',
  },
  {
    thaiName: 'การตักเตือนและหนุนใจ',
    score: 0,
    englishName: 'WarningAndEncouragement',
  },
  {
    thaiName: 'การรับใช้วิญญาณ',
    score: 0,
    englishName: 'ObservationOfSpirits',
  },
  ...
  {
    thaiName: 'การพูดภาษาแปลก',
    score: 0,
    englishName: 'SpeakingInStrangeLanguages',
  },
  {
    thaiName: 'การแปลภาษาแปลก',
    score: 0,
    englishName: 'TranslationOfStrangeLanguages',
  },
  { thaiName: 'อัครทูต', score: 0, englishName: 'Ambassador' },
  { thaiName: 'การอยู่เป็นโสด', score: 0, englishName: 'BeingSingle' },
  {
    thaiName: 'การอธิษฐานอ้อนวอน',
    score: 0,
    englishName: 'PrayerOfSupplication',
  },
